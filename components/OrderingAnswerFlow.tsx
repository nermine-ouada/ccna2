      ...
      <ol className="list-none space-y-0">
        {steps.map((step, i) => (
          <li key={`${i}-${step.slice(0, 48)}`}>
            <div className="flex gap-3 rounded-lg border border-emerald-100 bg-white/90 px-3 py-2.5">
            ...
            {i < steps.length - 1 ? (
              <div className="flex justify-center py-1.5 text-lg font-light text-emerald-700" aria-hidden>
                ↓
              </div>
            ) : null}
          </li>
